...
function Create() {
    ...
    const [getCampaign, setCampaign] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        title: "",
        description: "",
        videoUrl: "",
        imageUrl: ""
    ...
    function btnSaveClick() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$Web3Services$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addCampaign"])(getCampaign)//.then(tx => setMessage(JSON.stringify(tx)))
        .then((tx)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$Web3Services$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLastCampaignId"])()).then((id)=>setMessage(`Campanha foi salva com o ID ${id}. Em alguns minutos ela estará pronta para receber doaçoes
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8913bb2b._.js.map